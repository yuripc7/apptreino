...
export const gymRoutines: Record<number, any> = {
  1: {
    ...
    exercises: [
      ...
      { name: "Avanço", sets: "3", reps: "10 Cada lado", obs: "Se estiver leve, utilize halteres" },
      { name: "Romenian Deadlift", sets: "3", reps: "8", video: "https://www.youtube.com/watch?v=7j-2w4-P14I" },
      { name: "Cadeira extensora", sets: "3", reps: "Até a falha", obs: "Busque a falha entre 8 a 12 reps" },
  ...
  2: {
    ...
    exercises: [
      ...
      { name: "Tríceps corda + Tríceps banco", sets: "3", reps: "10+10", video: "https://www.youtube.com/watch?v=KhK5HWJfsrQ" }
    ]
  },
  3: {
    ...
    exercises: [
      ...
      { name: "Elevação Lateral", sets: "3", reps: "10", video: "https://www.youtube.com/shorts/UJ0dtSxmaRI" }
    ]
  },
  4: {
    title: "Core e Cardio",
    exercises: [
      { name: "Flexão tocando os pés", sets: "3", reps: "12", video: "https://www.youtube.com/watch?v=3KowrvjkwHg" },
  ...
  5: {
    ...
    exercises: [
      ...
      { name: "Triceps Corda", sets: "3", reps: "Até a falha", video: "https://www.youtube.com/shorts/-QGC1cL6ETE" },
  ...
  6: {
    title: "Cardio",
    exercises: [
      { name: "Corrida leve", sets: "1", reps: "30 min" }
    ]
  },
  0: {
    title: "Descanso",
...
export const getWorkoutDetails = (dayId: number, type: WorkoutType) => {
  if (type === 'Crossfit') {
    ...
    return {
      title: gymRoutines[dayId]?.title || "Academia",
      icon: <Dumbbell className="text-accent" size={20} />,
    };
  } else {
    return {
      title: "Descanso Total",
      icon: <Calendar className="text-text-secondary" size={20} />,
    };
  }
};
